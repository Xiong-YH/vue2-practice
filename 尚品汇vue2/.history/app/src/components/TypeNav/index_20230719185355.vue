...
export default {
    ...
    methods:{
        ...
        goSearch(event) {
            ...
            //获取到自定义属性
            let {categoryname,category1id,category2d,category3Id} = Element.dataset
            
            // let location = {name:}
            if(categoryname) {
                // this.$router.push({name:"Search",query:{category1id,category2id,category3id,categoryname}})
